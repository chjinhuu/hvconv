...
def parse_args():
    ...
    parser.add_argument(
        '--batch', type=int, default=1, help='batch number')
    parser.add_argument(
...
def measure_inference_speed(cfg, checkpoint, max_iter, log_interval,
                            is_fuse_conv_bn, use_fp16, batch):
    ...
    samples_per_gpu = cfg.data.test.pop('samples_per_gpu', batch)
...
def main():
    ...
    repeat_measure_inference_speed(cfg, args.checkpoint, args.max_iter // args.batch,
                                   args.log_interval, args.fuse_conv_bn,
                                   args.use_fp16, args.repeat_num, args.batch)
